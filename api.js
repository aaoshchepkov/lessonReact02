        ...
        <div className="features-wrapper">
          ...
          <div className="features-slider">
            <div className="features-slider_items">
              <FeaturesSliderItem text='Первое целевое преимущество' styleSrs={{ backgroundImage: "url(./images/1.svg)" }}/>
              <FeaturesSliderItem text='Второе целевое преимущество' styleSrs={{ backgroundImage: "url(./images/2.svg)" }}/>
              <FeaturesSliderItem text='Третье целевое преимущество' styleSrs={{ backgroundImage: "url(./images/3.svg)" }}/>
              <FeaturesSliderItem text='Четвертое целевое преимущество' styleSrs={{ backgroundImage: "url(./images/4.svg)" }}/>
            </div>
